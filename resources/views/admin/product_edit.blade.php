                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input value="{{old('price', $product->price)}}" type="number" id="price" name="price"
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input value="{{old('stock', $product->stock)}}" type="number" id="stock" name="stock"
                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            @error('stock')
                                <div class="text-red-400 text-sm">{{ $message }}</div>
                        ...
                        @if($product->cover)
                            <div class="p-2 w-full">
                                <img src="{{Storage::url($product->cover)}}" alt="Sem logo">
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <textarea value="{{old('description', $product->description)}}"
